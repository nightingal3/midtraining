...
model_name=${1:-pythia-160m}
checkpoint_dir=${2:-/home/nightingal3/fbsource/fbcode/ads_content_understanding/fmcu/projects/continue_pretrain_llm/models/EleutherAI/pythia-160m}
step=${3:-130000}
total_steps=${4:-143000}
pretraining_data_dir=${5:-/home/nightingal3/fbsource/fbcode/ads_content_understanding/fmcu/projects/continue_pretrain_llm/custom_texts/}
instruction_data_json=${6:-/home/nightingal3/fbsource/fbcode/ads_content_understanding/fmcu/projects/continue_pretrain_llm/datasets/databricks/databricks-dolly-15k/train.json}
max_seq_len=${7:-2048}
...
if [ $steps_remaining -gt 0 ]; then
  ...
  litgpt pretrain $model_name \
    ...
    --data TextFiles \
    --data.train_data_path "${pretraining_data_dir}" \
