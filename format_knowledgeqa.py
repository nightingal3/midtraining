...
KNOWLEDGEQA_PATH = "/data/users/nightingal3/manifold/all_in_one_pretraining/datasets/minicpm/knowledge_data/knowledge_data"
OUT_DIR = "/data/users/nightingal3/manifold/all_in_one_pretraining/datasets/knowledgeqa_formatted"
SUBDIRS = [
    "code",
    "dialogue",
    "openhermes",
    ...
    for subdir in SUBDIRS:
        ...
        for file in os.listdir(subdir_path):
            if file.endswith(".jsonl"):
                ...
                out_path = os.path.join(OUT_DIR, subdir, file)
